...
contract('BeamToken', function(accounts) {
    ...
    it ("Integration test: set start and end time of sale", function() {
        console.log('----------------');
        return bitweb_token_sale.setStartTimeOfSale(sale_start_block, {from: admin_addr, gas:4700000})
            .then(function() {
                return bitweb_token_sale.setEndTimeOfSale(sale_end_block, {from: admin_addr, gas:4700000})
            })
            .then(function() {
    ...
    it ("Integration test: transfer from bitweblab_reserve_addr to sliver_integration_addr", function() {
        ...
        return beam_token.balanceOf(bitweblab_reserve_addr)
            .then(function(res) {
                console.log('Beam reserve balance: ' + res);
    ...
    it ("Integration test: token purchase before sale starts", function() {
        ...
        return bitweb_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
        	.then(function() {
        		return beam_token.balanceOf(public_sale_addr);
        	})
        	.then(function(beam_balance) {
        		public_sale_addr_init_beam_balance = beam_balance;
        		public_sale_addr_init_eth_balance = web3.eth.getBalance(public_sale_addr);
        		console.log('public sale purchaser Beam balance: ' + public_sale_addr_init_beam_balance.toString());
        		console.log('public sale purchaser ETH balance: ' + public_sale_addr_init_eth_balance.toString());
        		console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitWebTokenSale...');
        		web3.eth.sendTransaction({from: public_sale_addr, to: bitweb_token_sale.address, value: purchase_eth, gas: 4700000});
            })
        	.catch(function() {
        	...
        	.then(function(beam_balance) {
        		public_sale_addr_final_beam_balance = beam_balance;
        		public_sale_addr_final_eth_balance = web3.eth.getBalance(public_sale_addr);
        		console.log('public sale purchaser Beam balance: ' + public_sale_addr_final_beam_balance.toString());
        		console.log('public sale purchaser ETH balance: ' + public_sale_addr_final_eth_balance.toString());
        		assert(public_sale_addr_final_beam_balance.equals(public_sale_addr_init_beam_balance), 'should not change!');
            })
    });
    ...
    it ("Integration test: special account balance checks #3", function() {
        ...
        return beam_token.totalSupply()
            .then(function(supply) {
                current_supply = new web3.BigNumber(supply);
                return beam_token.balanceOf(bitweblab_reserve_addr);
            })
            .then(function(bitweblab_balance) {
                bitweblab_reserve_balance = new web3.BigNumber(bitweblab_balance);
                ...
                console.log('Beam Labs reserve balance  : ' + bitweblab_reserve_balance);
                console.log('pre-circulation total amount: ' + precirculation_amount);

                console.log('reserve ratio: ' + bitweblab_reserve_balance.plus(precirculation_amount).dividedBy(current_supply));

                assert(current_supply.times(0.6).minus(bitweblab_reserve_balance).minus(precirc_amount) < +EPSILON,  'invalid bitweblab_reserve_balance ratio');
                assert(current_supply.times(0.6).minus(bitweblab_reserve_balance).minus(precirc_amount) > -EPSILON, 'invalid bitweblab_reserve_balance ratio');                
            })
    });
    ...
    it ("Integration test: token purchase after sale starts", function() {
        ...
        return bitweb_token_sale.activateSale({from: admin_addr, gas: 4700000})
            .then(function() {
                return bitweb_token_sale.changeTokenSaleHardCap(presale_amount.plus(purchase_eth.times(exchange_rate).times(10000)));
            })
            .then(function() {
                return bitweb_token_sale.changeFundCollectedHardCap(purchase_eth.times(10000));
            })
        	.then(function() {
        		return bitweb_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000});	
        	})
        	...
        	.then(function(beam_balance) {
        		public_sale_addr_init_beam_balance = new web3.BigNumber(beam_balance);
        		public_sale_addr_init_eth_balance = new web3.BigNumber(web3.eth.getBalance(public_sale_addr));
        		console.log('public sale purchaser Beam balance: ' + public_sale_addr_init_beam_balance.toString());
        		console.log('public sale purchaser ETH balance: ' + public_sale_addr_init_eth_balance.toString());
        		console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitWebTokenSale...');
        		tx_hash = web3.eth.sendTransaction({from: public_sale_addr, to: bitweb_token_sale.address, value: purchase_eth, gas: 4700000});
        	...
        	.then(function(beam_balance) {
        		public_sale_addr_final_beam_balance = new web3.BigNumber(beam_balance);
        		public_sale_addr_final_eth_balance = new web3.BigNumber(web3.eth.getBalance(public_sale_addr));
        		console.log('public sale purchaser Beam balance: ' + public_sale_addr_final_beam_balance.toString());
        		console.log('public sale purchaser ETH balance: ' + public_sale_addr_final_eth_balance.toString());
        		assert(public_sale_addr_final_beam_balance.minus(public_sale_addr_init_beam_balance).equals(purchase_eth * exchange_rate), 'should decrease!');
    ...
    it ("Integration test: token purchase from non-whitelisted addresses after sale starts", function() {
        ...
        purchase_eth = new web3.BigNumber(1 * Math.pow(10,18));
        return bitweb_token_sale.deleteAccountsFromWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            .then(function() {
                return beam_token.balanceOf(public_sale_addr);
            })
            .then(function(beam_balance) {
                ...
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_init_eth_balance.toString());
                console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitWebTokenSale...');
                return web3.eth.sendTransaction({from: public_sale_addr, to: bitweb_token_sale.address, value: purchase_eth, gas: 4700000});
            })
            .catch(function() {
            ...
            .then(function(beam_balance) {
                ...
                console.log('public sale purchaser Beam balance: ' + public_sale_addr_final_beam_balance.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_final_eth_balance.toString());
                assert(public_sale_addr_final_beam_balance.equals(public_sale_addr_init_beam_balance), 'should decrease!');
    ...
    it ("Integration test: token purchase with less than minially required ETH", function() {
        ...
        return bitweb_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            ...
            .then(function(beam_balance) {
                ...
                return bitweb_token_sale.changeMinimalPayment(purchase_eth, {from: admin_addr});
            })
            .then(function() {
                return beam_token.balanceOf(public_sale_addr);
            })
            ...
            .then(function(beam_balance) {
                ...
                console.log('public sale purchaser Beam balance: ' + public_sale_addr_final_beam_balance.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_final_eth_balance.toString());
                assert(public_sale_addr_final_beam_balance.equals(public_sale_addr_init_beam_balance.plus(purchase_eth * exchange_rate)), 'should increase by purchased amount!');
                assert(public_sale_addr_init_eth_balance.greaterThan(public_sale_addr_final_eth_balance), 'should cost some gas!');
                console.log('Changing minimal payment back to 1 ether')
                return bitweb_token_sale.changeMinimalPayment(1000000000000000000, {from: admin_addr});
            })
            .then(function() {
                return bitweb_token_sale.minimalPayment.call();
            })
    ...
    it ("Integration test: token purchase when sold token count approaches the hard cap", function() {
        ...
        return bitweb_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            ...
            .then(function(supply) {
                ...
                return bitweb_token_sale.changeTokenSaleHardCap(new_token_sale_hard_cap);
            })
            .then(function() {
                return bitweb_token_sale.tokenSaleHardCap.call();
            })
            .then(function(token_hard_cap) {
                ...
                return bitweb_token_sale.changeFundCollectedHardCap(new_fund_collected_hard_cap);
            })
            .then(function() {
                return bitweb_token_sale.fundCollectedHardCap.call();
            })
            ...
            .then(function(beam_balance) {
                public_sale_addr_beam_balance_1 = beam_balance;
                public_sale_addr_eth_balance_1 = web3.eth.getBalance(public_sale_addr);
                console.log('public sale purchaser Beam balance: ' + public_sale_addr_beam_balance_1.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_1.toString());
                assert(public_sale_addr_beam_balance_1.minus(public_sale_addr_init_beam_balance).equals(purchase_eth.times(exchange_rate)), 'should increase!');
            ...
            .then(function(supply) {
                ...
                return bitweb_token_sale.getFundCollected({from: admin_addr, gas: 4700000});
            })
            ...
            .then(function(beam_balance) {
                public_sale_addr_beam_balance_2 = beam_balance;
                public_sale_addr_eth_balance_2 = web3.eth.getBalance(public_sale_addr);
                console.log('public sale purchaser Beam balance: ' + public_sale_addr_beam_balance_2.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_2.toString());
                assert.equal(public_sale_addr_beam_balance_2 - public_sale_addr_beam_balance_1, 0, 'should not change!');
    ...
    it ("Integration test: token purchase when total fund collected approaches the hard cap", function() {
        ...
        return bitweb_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            ...
            .then(function(fund_collected) {
                ...
                return bitweb_token_sale.changeFundCollectedHardCap(new_fund_collected_hard_cap, {from: admin_addr, gas: 4700000});
            })
            .then(function() {
                return bitweb_token_sale.fundCollectedHardCap.call();
            })
            ...
            .then(function() {
                ...
                return bitweb_token_sale.changeTokenSaleHardCap(new_token_sale_hard_cap, {from: admin_addr, gas: 4700000});
            })
            .then(function() {
                return bitweb_token_sale.tokenSaleHardCap.call();
            })
            ...
            .then(function(beam_balance) {
                ...
                //             Number(public_sale_addr_eth_balance_1) + Number(purchase_eth) + Number(tx_gas_used), 'ETH balance should decrease by the expected amount!');                return beam_token.totalSupply();
                return beam_token.totalSupply();
            })
            .then(function(supply) {
                current_supply = Number(supply);
            ...
            .then(function(beam_balance) {
                ...
                console.log('public sale purchaser Beam balance: ' + public_sale_addr_beam_balance_2.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_2.toString());
                assert(public_sale_addr_beam_balance_2.equals(public_sale_addr_beam_balance_1), 'should not change!');
                assert(public_sale_addr_eth_balance_1.greaterThan(public_sale_addr_eth_balance_2), 'should cost some gas!');
                return beam_token.totalSupply();
            })
            .then(function(supply) {
    ...
    it ("Integration test: emergency sale stop/restart", function() {
        ...
        return bitweb_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            ...
            .then(function(beam_balance) {
                ...
                console.log('public sale purchaser Beam balance: ' + public_sale_addr_beam_balance_1.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_1.toString());
                assert(public_sale_addr_beam_balance_1.minus(public_sale_addr_init_beam_balance).equals(purchase_eth * exchange_rate), 'should increase!');
                assert(public_sale_addr_init_eth_balance.greaterThan(public_sale_addr_eth_balance_1.plus(purchase_eth)), 'should decrease!');
                return bitweb_token_sale.emergencyStopSale({from: admin_addr, gas: 4700000});
            })
            .then(function() {
                console.log('');
                console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitWebTokenSale...');
            ...
            .then(function(beam_balance) {
                ...
                assert(public_sale_addr_beam_balance_2.equals(public_sale_addr_beam_balance_1), 'should not change!');
                assert(public_sale_addr_eth_balance_1.greaterThan(public_sale_addr_eth_balance_2), 'should cost some gas!');
                return bitweb_token_sale.restartSale({from: admin_addr, gas: 4700000});
            })
            .then(function() {
                console.log('');
                console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitWebTokenSale...');
            ...
            .then(function(beam_balance) {
                public_sale_addr_beam_balance_3 = beam_balance;
                public_sale_addr_eth_balance_3 = web3.eth.getBalance(public_sale_addr);
                console.log('public sale purchaser Beam balance: ' + public_sale_addr_beam_balance_3.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_3.toString());
                assert(public_sale_addr_beam_balance_3.minus(public_sale_addr_beam_balance_2).equals(purchase_eth.times(exchange_rate)), 'should increase!');
    ...
    it ("Integration test: token transfer() before unlockTime", function() {
        ...
        return bitweb_token_sale.allowPrecirculation(presale_addr, {from: admin_addr, gas: 4700000})
            .then(function() {
                return bitweb_token_sale.allowPrecirculation(precirculation_allowed_addr, {from: admin_addr, gas: 4700000});
            })
            .then(function() {
                return beam_token.balanceOf(presale_addr);
            })
            .then(function(balance) {
                ...
                return beam_token.balanceOf(precirculation_allowed_addr);
            })
            .then(function(balance) {
                ...
                return beam_token.transfer(precirculation_allowed_addr, transfer_amount_1, {from: presale_addr, gas: 4700000})
            })
            .then(function() {
                return beam_token.balanceOf(presale_addr);
            })
            ...
            .then(function() {
                ...
                return beam_token.transfer(presale_addr, transfer_amount_2, {from: precirculation_allowed_addr, gas: 4700000});
            })
            .catch(function() {
            ...
            .then(function(balance) {
                ...
                console.log('presale purchase balance: ' + presale_purchaser_after_first_transfer.toString());
                return beam_token.balanceOf(precirculation_disallowed_addr);
            })
            .then(function(balance) {
                ...
                return beam_token.transfer(precirculation_disallowed_addr, transfer_amount_1, {from: presale_addr, gas: 4700000})
            })
            .catch(function() {
    ...
    it ("Integration test: token transferFrom() before unlockTime", function() {
        ...
        return bitweb_token_sale.allowPrecirculation(presale_addr, {from: admin_addr, gas: 4700000})
            ...
            .then(function() {
                ...
                return beam_token.approve(transfer_operator, allowance_amount, {from: presale_addr, gas: 4700000});
            })
            .then(function() {
                return beam_token.allowance(presale_addr, transfer_operator);
            })
            ...
            .then(function(balance) {
                ...
                return beam_token.transferFrom(presale_addr, precirculation_allowed_addr, transfer_amount_1, 
            ...
            .then(function(balance) {
                ...
                return beam_token.transferFrom(presale_addr, precirculation_allowed_addr, transfer_amount_2, 
                    {from: transfer_operator, gas: 4700000});
            })
            .then(function() {
                return beam_token.allowance(presale_addr, transfer_operator);
            ...
            .then(function() {
                console.log('');
                return bitweb_token_sale.allowPrecirculation(transfer_operator, {from: admin_addr, gas: 4700000});
            })
            .then(function() {
                return beam_token.allowance(presale_addr, transfer_operator);
            })
            ...
            .then(function(balance) {
                ...
                return beam_token.transferFrom(presale_addr, precirculation_disallowed_addr, transfer_amount_3, 
                    {from: transfer_operator, gas: 4700000});
            })
            .catch(function() {
    ...
    it ("Integration test: attempt to purchase tokens after token sale ends", function() {
        ...
        return beam_token.totalSupply()
            ...
            .then(function(beam_balance) {
                public_sale_addr_beam_balance_1 = new web3.BigNumber(beam_balance);
                public_sale_addr_eth_balance_1 = web3.eth.getBalance(public_sale_addr);
                console.log('public sale purchaser Beam balance: ' + public_sale_addr_beam_balance_1.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_1.toString());
                assert(public_sale_addr_beam_balance_1.equals(public_sale_addr_init_beam_balance), 'should not change!');
    ...
    it ("Integration test: token transfer() after unlockTime", function() {
        ...
        return bitweb_token_sale.allowPrecirculation(presale_addr, {from: admin_addr, gas: 4700000})
            ...
            .then(function() {
                return bitweb_token_sale.disallowPrecirculation(precirculation_disallowed_addr, {from: admin_addr, gas: 4700000});
            })
            .then(function() {
                return beam_token.balanceOf(presale_addr);
            })
    ...
    it ("Integration test: token transferFrom() after unlockTime", function() {
        ...
        return bitweb_token_sale.allowPrecirculation(presale_addr, {from: admin_addr, gas: 4700000})
            ...
            .then(function() {
                return beam_token.approve(transfer_operator, 0, {from: presale_addr, gas: 4700000});
            })
            .then(function() {
                console.log('approving allowance: ' + allowance_amount.toString());
                return beam_token.approve(transfer_operator, allowance_amount, {from: presale_addr, gas: 4700000});
